...
const Options = (props) =>(
          <div>
            ...
            <div className="widget-header">
              <h3 className="widget-header__title">Your Options: {props.allOptions.length}</h3>
              <button className="button button--link" onClick={props.resettingOptions} disabled={!props.gotSomethingToWipe}>Wipe All</button>
            </div>
